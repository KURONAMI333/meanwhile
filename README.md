...
Downloads: [CurseForge](https://www.curseforge.com/minecraft/mc-mods/meanwhile) · [GitHub Releases](https://github.com/KURONAMI333/meanwhile/releases/tag/v0.1.0).

For bugs and questions, comment on the [CurseForge page](https://www.curseforge.com/minecraft/mc-mods/meanwhile) or DM [@kuronami333 on X](https://x.com/kuronami333).

[Source](https://github.com/KURONAMI333/meanwhile) · [License](LICENSE)
